...
final private[mima] class FieldInfo(owner: ClassInfo, bytecodeName: String, flags: Int, descriptor: String)
...
final private[mima] class MethodInfo(owner: ClassInfo, bytecodeName: String, flags: Int, descriptor: String)
    extends MemberInfo(owner, bytecodeName, flags, descriptor) {
