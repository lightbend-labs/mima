...
import ssol.tools.mima.client.{MiMaClient,Writer,WriterConfig}
...
private[ui] object ClientWizard {
...
private[ui] class ClientWizard extends Wizard {

  /** Default WizardPage */
  private trait Page extends WizardPage {
    import ClientWizard.PageModel
    ...
    override def onLoad() {
      ...
      fixes match {
        ...
        case _ =>
          ...
          new Writer(fixes, config).writeOut()
      }
    }
  }
}