...
class IntegrationTestSuite extends munit.FunSuite {
  ...
  test("scala-library-2-11")(
    testIntegration("org.scala-lang", "scala-library", "2.11.0", "2.11.12")(
      problemFilters = List(
  ...
  test("scala-library-2-12")(
    testIntegration("org.scala-lang", "scala-library", "2.12.0", "2.12.10")(
      problemFilters = List(
        // all
  ...
  test("scala-library-2-13")(
    testIntegration("org.scala-lang", "scala-library", "2.13.0", "2.13.1")(
      expected = List(
  ...
  test("scala-reflect-2-10")(
    testIntegration("org.scala-lang", "scala-reflect", "2.10.0", "2.10.7")(
      expected = List(
  ...
  test("scala-reflect-2-11")(
    testIntegration("org.scala-lang", "scala-reflect", "2.11.0", "2.11.12")(
      problemFilters = List(
        exclude[Problem]("scala.reflect.internal.*"),
        exclude[IncompatibleResultTypeProblem](
          "scala.reflect.api.Internals#ReificationSupportApi#SyntacticTypeAppliedExtractor.unapply"
        ),
        exclude[IncompatibleSignatureProblem]("scala.reflect.io.ZipArchive#Entry.underlyingSource"),
        exclude[IncompatibleSignatureProblem]("scala.reflect.io.ZipArchive.underlyingSource"),
  ...
  test("scala-reflect-2-12")(
    testIntegration("org.scala-lang", "scala-reflect", "2.12.1", "2.12.10")(
      problemFilters = List(
        exclude[Problem]("scala.reflect.internal.*"),
        ...
        exclude[ReversedMissingMethodProblem](
          "scala.reflect.runtime.SynchronizedTypes.scala$reflect$runtime$SynchronizedTypes$$super$defineNormalized"
        )
      )
    )
  )

  test("scala-reflect-2-13")(
    testIntegration("org.scala-lang", "scala-reflect", "2.13.0", "2.13.1")(
      problemFilters = List(
        exclude[Problem]("scala.reflect.internal.*"),
  ...
  test("scala3-library")(
    testIntegration("org.scala-lang", "scala3-library_3", "3.0.0", "3.0.1")(
